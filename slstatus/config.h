...
static const struct arg args[] = {
  ...
  { run_command,  "cpu %s°C | ",    "cat /sys/devices/pci0000:00/0000:00:18.3/hwmon/hwmon*/temp1_input | sed -r 's/([0-9]{2})([0-9]{1})([0-9]{2})/\1.\2/g'" },
  { run_command,  "gpu %s°C | ",    "cat /sys/devices/pci0000:00/0000:00:03.1/0000:2a:00.0/0000:2b:00.0/0000:2c:00.0/hwmon/hwmon*/temp1_input | sed -r 's/([0-9]{2})([0-9]{1})([0-9]{2})/\1.\2/g'" },
	{ datetime,     "%s ",            "%a %b %d %R" },
};
